...
describe('Person', () => {
  ...
  beforeEach(() => {
    ...
    sandbox.stub(paul, 'isOwner').returns(true)
  ...
  describe('isAlive', () => {
    it('works', () => {
      expect(paul.isAlive()).to.be.true()
    })
  ...
  describe('isPrivate', () => {
    beforeEach(() => {
      sandbox.stub(paul, 'isAlive').returns('ALIVE')
    })
    ...
    describe('for other users', () => {
      beforeEach(() => {
        paul.isOwner.returns(false)
      })

      it('depends on them being alive', () => {
        expect(paul.isPrivate()).to.equal('ALIVE')
      })
    })
